...
import {
  Plus, CheckCircle, Clock, AlertTriangle, User, Calendar,
...
export default function TaskList({ project, tasks, user }) {
  ...
  const createTaskMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setNewTask({ title: '', description: '', assignee: '', priority: 'medium', category: 'other', due_date: '' });
    }
  });
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => setShowAddTask(true)} className="gap-2 bg-violet-600 hover:bg-violet-700">
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onClick={() => updateTaskMutation.mutate({ id: task.id, data: { status: 'review' } })}>
                              Move to Review
                            </DropdownMenuItem>
