  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2 max-h-80 overflow-y-auto">
        {renewals.sort((a, b) => a.days_to_renewal - b.days_to_renewal).slice(0, 15).map(renewal => {
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-gray-900 dark:text-white">${renewal.contract_value?.toLocaleString()}</p>
                    <Badge className={
                      renewal.renewal_status === 'at_risk' ? 'bg-red-100 text-red-800' :
                      renewal.renewal_status === 'likely' ? 'bg-green-100 text-green-800' :
