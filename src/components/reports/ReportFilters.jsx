  ...
  const getFilterFields = () => {
    switch (reportType) {
      case 'campaign_performance':
        return [
          { id: 'campaign_type', label: 'Campaign Type', type: 'select', options: ['email', 'social_media', 'ppc', 'content', 'seo', 'event', 'referral', 'other'] },
          { id: 'campaign_status', label: 'Status', type: 'select', options: ['draft', 'active', 'paused', 'completed'] },
      ...
      case 'contacts_by_source':
        return [
          ...
          { id: 'source', label: 'Source', type: 'select', options: ['website', 'referral', 'linkedin', 'cold_outreach', 'event', 'other'] },
          { id: 'campaign_id', label: 'Campaign', type: 'campaign' },
        ];
      case 'deals_pipeline':
        return [
          { id: 'stage', label: 'Stage', type: 'select', options: ['lead', 'qualified', 'proposal', 'negotiation', 'won', 'lost'] },
      ...
      case 'backlink_profile':
        return [
          { id: 'link_type', label: 'Link Type', type: 'select', options: ['dofollow', 'nofollow', 'ugc', 'sponsored'] },
