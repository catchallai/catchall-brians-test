          ...
          return (
            ...
            >
              <CardContent className="p-4">
                ...
                <div
                  className={`w-10 h-10 rounded-lg flex items-center justify-center mb-3 ${template.iconBg}`}
                >
                  <Icon className={`w-5 h-5 ${isCustom ? 'text-white' : ''}`} />
                </div>
                <h3
                  className={`font-medium text-sm mb-1 ${isCustom ? 'text-white' : 'text-gray-900 dark:text-white'}`}
                >
                  {template.name}
                </h3>
                <p
                  className={`text-xs line-clamp-2 ${isCustom ? 'text-white/80' : 'text-gray-500 dark:text-gray-400'}`}
                >
