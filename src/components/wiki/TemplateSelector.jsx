...
export default function TemplateSelector({ open, onClose, templates, onSelectTemplate, onCreateBlank, requireTemplate = false, defaultTemplateId = null }) {
          ...
          <div className="flex-1 overflow-y-auto">
            <Tabs defaultValue="all">
              ...
              <TabsContent value="all" className="mt-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {templates.map((template) => (
                    ...
                    >
                      <div className="flex flex-col gap-3" onClick={() => setPreviewTemplate(template)}>
              ...
              <TabsContent value="custom" className="mt-4">
                <div className="grid grid-cols-2 gap-4">
                  {templates.filter(t => t.created_by === 'custom').map((template) => (
                    <Card 
                      key={template.id}
