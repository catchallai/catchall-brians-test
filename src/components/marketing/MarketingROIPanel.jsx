...
export default function MarketingROIPanel({ deals, contacts, utmData }) {
  ...
  // ROI calculation
  const roi = estimatedAdSpend > 0 ? (((totalRevenue - estimatedAdSpend) / estimatedAdSpend) * 100).toFixed(0) : 0;
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Marketing ROI Dashboard</h2>
        <p className="text-sm text-gray-500">Track cost-per-lead, conversion rates, and overall ROI</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <Card className="glass-card rounded-2xl">
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-gray-900 dark:text-white">${avgDealSize.toLocaleString()}</p>
