  ...
  const calculateScoreMutation = useMutation({
    mutationFn: async () => {
      for (const contact of contacts) {
        ...
        if (contact.job_title?.toLowerCase().includes('director') || 
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Automatically score leads based on demographics, behavior, and engagement</p>
        </div>
        <Button 
          ...
          {sortedScores.length === 0 ? (
            ...
            <div className="space-y-3">
              {sortedScores.slice(0, 15).map((score) => {
                ...
                return (
                  <div key={score.id} className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <div className="w-32">
                      ...
                      <p className="text-xs text-gray-500 mt-1 text-right">{score.total_score}/100</p>
                    </div>
