...
export default function DependencyManager({ taskId, allTasks = [], dependencies = [] }) {
  ...
  const availableTasks = allTasks.filter(t => t.id !== taskId && !taskDeps.find(d => d.depends_on_task_id === t.id));
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          {taskDeps.map((dep) => {
            ...
            return (
              <div key={dep.id} className="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-800 rounded">
