        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
              ...
              <p className="text-xs text-green-600 dark:text-green-400 mt-1">{paid.length} reservations</p>
            </div>
            ...
            <div className="p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
              ...
              <p className="text-xs text-yellow-600 dark:text-yellow-400 mt-1">{unpaid.length} reservations</p>
            </div>
            ...
            <div className="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
              ...
              <p className="text-xs text-red-600 dark:text-red-400 mt-1">{overdue.length} reservations</p>
            </div>
          </div>
        </CardContent>
      </Card>
