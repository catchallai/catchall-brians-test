                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex flex-wrap gap-1 mb-3">
                    {template.platforms?.map(p => (
                      <Badge key={p} className="text-xs bg-violet-100 text-violet-700 dark:bg-violet-900 dark:text-violet-300">
                        {p}
                      </Badge>
                    ))}
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-gray-500">Used {template.usage_count || 0} times</span>
