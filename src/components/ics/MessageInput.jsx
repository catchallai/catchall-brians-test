  ...
  return (
    <div className="space-y-2">
      ...
      <form onSubmit={handleSend} className="space-y-2">
        <div className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-white shadow-sm">
          ...
          <Input
            ...
            className="flex-1 bg-transparent outline-none border-0 text-slate-900 placeholder:text-slate-400"
          />
