           ...
           {contact.email && (
            ...
            {contact.linkedin_url && (
              <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                ...
                <a href={contact.linkedin_url} target="_blank" rel="noopener noreferrer" className="hover:text-violet-600">
                  LinkedIn
                </a>
              </div>
            )}
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card className="glass-card">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">${(totalDealValue / 1000).toFixed(0)}k</p>
