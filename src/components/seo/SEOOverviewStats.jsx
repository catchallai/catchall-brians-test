      ...
      {stats.map((stat) => (
        ...
        >
          ...
          <div className="flex items-start justify-between">
            <div className={`p-2.5 rounded-xl bg-gradient-to-br ${stat.gradient} text-white shadow-lg group-hover:scale-110 transition-transform`}>
              <stat.icon className="w-5 h-5" />
            </div>
            {stat.trend && (
              <div className={`flex items-center gap-0.5 text-xs font-medium ${stat.trend === 'up' ? 'text-emerald-600' : 'text-amber-600'}`}>
          ...
          <div className={`mt-3 inline-flex items-center gap-2 px-2.5 py-1 rounded-lg ${stat.bgLight}`}>
