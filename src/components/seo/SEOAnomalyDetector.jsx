...
export default function SEOAnomalyDetector({ websites, keywords, backlinks, onDetectAnomalies }) {
      ...
      <CardContent>
        {!anomalies ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 text-sm">Run detection to find ranking drops, traffic anomalies, and technical issues</p>
          </div>
        ) : anomalies.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 text-sm">No anomalies detected. Your SEO is performing normally.</p>
          </div>
        ) : (
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <Badge className={`text-xs ${
                        anomaly.severity === 'critical' ? 'bg-red-100 text-red-700 border-red-300' :
                        anomaly.severity === 'high' ? 'bg-orange-100 text-orange-700 border-orange-300' :
