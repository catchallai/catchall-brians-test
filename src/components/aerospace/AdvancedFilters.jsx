        ...
        <div className="flex items-center justify-between">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select value={filters.company_type} onValueChange={(value) => setFilters(prev => ({ ...prev, company_type: value }))}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFilters(prev => ({ ...prev, revenue_growth_min: e.target.value }))}
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFilters(prev => ({ ...prev, employee_count_min: e.target.value }))}
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFilters(prev => ({ ...prev, contract_value_min: e.target.value }))}
              />
            </div>
