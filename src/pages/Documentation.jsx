  ...
  crmCore: {
    ...
    pages: [
      ...
      },
      {
        ...
        whatItDoes: "Visual network graph showing relationships between contacts, companies, and deals to identify key stakeholders and deal dynamics.",
        howItWorks: "System creates relationship graph from contact/company/deal associations. Visualization shows network dependencies and influencers. Identifies multi-threading opportunities.",
        useCases: [
        ...
        businessValue: "Increase deal size by 25-30% through multi-threading. Reduce deal risk by identifying and managing all stakeholders."
      }
    ]
  },
  sales: {
    ...
    pages: [
      ...
      },
      {
        ...
        whatItDoes: "Log calls with automatic duration tracking, outcome recording, transcription, and sentiment analysis for coaching and analytics.",
        howItWorks: "Log call manually or auto-capture from phone system, record outcome and next steps, transcription captured, sentiment analyzed, follow-up tasks auto-created.",
        useCases: [
        ...
        businessValue: "Improve sales rep effectiveness by 20-25% through coaching on real call data. Identify scaling coaching topics."
      },
      {
        name: "Sales Forecasting",
        icon: "📊",
        description: "Revenue prediction and pipeline health",
        whatItDoes: "Automatically calculate weighted pipeline forecast based on deal values, stages, and historical close rates.",
        howItWorks: "System aggregates deals, applies probability weights by stage, calculates expected revenue, compares to actuals for variance analysis.",
        useCases: [
        ...
        businessValue: "Improve forecast accuracy by 30-40%. Identify and save 5-10% of at-risk revenue before it's lost."
      }
    ]
  },
  marketing: {
    ...
    pages: [
      ...
      },
      {
        ...
        whatItDoes: "Plan and coordinate all content across email, social, blog, and web with approval workflows and publishing automation.",
        howItWorks: "Plan topics in calendar, assign to team members, route through approval workflow, auto-publish on configured channels, track performance.",
        useCases: [
        ...
        businessValue: "Increase publishing consistency which drives 30-40% more traffic. Reduce administrative overhead by 50% through automation."
      },
      {
        name: "Lead Scoring",
        icon: "⭐",
      ...
      },
      {
        ...
        whatItDoes: "Orchestrate complex, multi-touch campaigns across email, landing pages, social, and other channels with centralized tracking.",
        howItWorks: "Create campaign workflow, configure channels and messaging, set budget/timeline, launch automated workflow, track ROI through analytics.",
        useCases: [
        ...
        businessValue: "Increase campaign ROI by 30-40% through better optimization. Demonstrate marketing value and secure budget for future campaigns."
      }
    ]
  },
  customerSuccess: {
    ...
    pages: [
      ...
      },
      {
        ...
        whatItDoes: "Collect NPS and CSAT feedback automatically, analyze sentiment, and track action items through resolution.",
        howItWorks: "Create surveys with triggers, collect responses, sentiment analyzed and tagged, action items created from negative feedback, track closure.",
        useCases: [
        ...
        businessValue: "Improve NPS by 10-15 points through addressing feedback. Increase referrals and expansion from promoters."
      },
      {
      ...
      },
      {
        ...
        whatItDoes: "Identify and recommend upsell/cross-sell opportunities based on usage, features, and benchmarking.",
        howItWorks: "Analyze usage patterns, identify feature gaps, match against playbooks, recommend upsell to CSM, track conversation and outcome.",
        useCases: [
        ...
        businessValue: "Increase expansion revenue by 20-30% with systematic approach. Reduce dependency on new customer acquisition."
      }
    ]
  },
  seo: {
    ...
    pages: [
      ...
      },
      {
        ...
        whatItDoes: "Analyze backlink profile, identify quality links, detect toxic links, and find link building opportunities.",
        howItWorks: "Index backlink profile, score links for quality/toxicity, benchmark vs. competitors, alert on new links, recommend opportunities.",
        useCases: [
        ...
        businessValue: "Improve link profile quality by 30-40%. Identify competitors' link sources to replicate strategy."
      },
      {
        name: "Content Performance",
        icon: "📊",
        description: "Content effectiveness and optimization",
        whatItDoes: "Measure content performance, identify gaps, detect cannibalization, and recommend optimizations.",
        howItWorks: "Analyze top/underperforming pages, identify content issues, detect topic overlap, recommend consolidation or updates.",
        useCases: [
        ...
        businessValue: "Increase organic traffic by 25-40% through content optimization. Reduce wasted content efforts by 30-40%."
      },
      {
        name: "Competitor Analysis",
        icon: "⚔️",
        description: "Competitive landscape monitoring",
        whatItDoes: "Analyze competitor websites, rankings, content, backlinks, and identify opportunities to outrank them.",
        howItWorks: "Monitor competitor websites, compare keywords/rankings/content/links, identify ranking opportunities, track strategy changes.",
        useCases: [
        ...
        businessValue: "Identify 20-30% more ranking opportunities through competitor analysis. Outrank competitors systematically."
      }
    ]
  },
  social: {
    ...
    pages: [
      ...
      },
      {
        ...
        whatItDoes: "Unified inbox for all comments and direct messages with team assignment and response tracking.",
        howItWorks: "All comments/DMs flow to unified inbox, team assigned to respond, responses tracked for speed/quality, metrics tracked.",
        useCases: [
        ...
        businessValue: "Improve customer satisfaction through faster response times. Convert engaged followers to customers/advocates."
      },
      {
        name: "Social Analytics",
        icon: "📈",
        description: "Performance measurement and ROI",
        whatItDoes: "Measure social media impact with metrics, growth tracking, audience insights, and competitive benchmarking.",
        howItWorks: "Aggregate metrics from all platforms, calculate engagement rates/growth, identify top content, compare vs. competitors.",
        useCases: [
        ...
        businessValue: "Demonstrate social media ROI to secure budget. Optimize strategy based on performance data to improve results."
      }
    ]
  },
  projects: {
    ...
    pages: [
      ...
      },
      {
        ...
        whatItDoes: "Unified communication with comments, mentions, file sharing, and activity feeds.",
        howItWorks: "Team members collaborate on shared tasks, comments and mentions keep everyone informed, files stored centrally, activity feed shows updates.",
        useCases: [
        ...
        businessValue: "Reduce communication overhead by 30-40%. Improve team satisfaction and retention."
      },
      {
        name: "Kanban Boards",
        icon: "📊",
        description: "Visual workflow management",
        whatItDoes: "Visualize workflow with drag-and-drop columns, WIP limits, and automated transitions.",
        howItWorks: "Create board with custom columns, drag cards as work progresses, automation rules trigger on status change.",
        useCases: [
        ...
        businessValue: "Increase team productivity by 15-25%. Identify and remove process bottlenecks."
      },
      {
        name: "Time Tracking",
        icon: "⏱️",
        description: "Resource utilization and billing",
        whatItDoes: "Track time spent on projects and tasks for billing, payroll, and profitability analysis.",
        howItWorks: "Team logs time against tasks, manager approves timesheet, data used for billing/payroll/profitability analysis.",
        useCases: [
        ...
        businessValue: "Increase billing accuracy and recovery by 10-15%. Identify unprofitable projects for management."
      }
    ]
  }
};
...
const SectionCollapsible = ({ section, isOpen, onToggle }) => {
  ...
  return (
    <div className="space-y-3">
      ...
      >
        <h3 className={`font-bold text-lg ${isOpen ? `text-${section.color}-700 dark:text-${section.color}-300` : 'text-gray-700 dark:text-gray-300'}`}>
          {section.title}
        </h3>
    ...
    <div className="p-6 lg:p-8 space-y-8 min-h-screen max-w-6xl mx-auto">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">Detailed breakdown of every feature, use case, and business value</p>
        </div>
