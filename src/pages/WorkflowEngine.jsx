    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 to-cyan-50 dark:from-slate-950 dark:via-slate-900 dark:to-violet-950 p-4 sm:p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">Workflow Engine</h1>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mt-1">Automate customer engagement sequences</p>
          </div>
