...
import { Plus, Search, Box, DollarSign, Edit, Upload, Package } from "lucide-react";
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center max-w-2xl mx-auto">
              <div className="mb-8">
                <svg width="200" height="140" viewBox="0 0 200 140" fill="none" className="mx-auto">
                  <rect x="60" y="20" width="80" height="100" rx="4" fill="#E0E7FF" stroke="#6366F1" strokeWidth="2"/>
                  <circle cx="100" cy="50" r="15" fill="#6366F1"/>
                  <path d="M100 40 L100 60 M90 50 L110 50" stroke="white" strokeWidth="3" strokeLinecap="round"/>
                  ...
                  <path d="M160 90 Q160 95, 165 100 L175 85" stroke="white" strokeWidth="3" strokeLinecap="round" fill="none"/>
                </svg>
              </div>
              ...
              <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400 text-left max-w-lg mb-6">
                <p className="flex gap-2"><span className="text-violet-600">→</span> Organize and store your product data so your sales team can easily sell and get paid</p>
                <p className="flex gap-2"><span className="text-violet-600">→</span> Add and reuse your products for sending deals, quotes, invoices, and payment links to customers</p>
                <p className="flex gap-2"><span className="text-violet-600">→</span> Configure quantity-based pricing tiers and easily access in-depth sales performance reporting of products and services in your library</p>
              </div>
