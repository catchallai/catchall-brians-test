      ...
      <div className="flex-1 flex flex-col">
        <div className="border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-slate-900 p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Emails</h1>
        ...
        <div className="flex-1 overflow-auto p-6 sm:p-8">
          <EmptyState icon={Mail} title="No emails yet" description="Start sending emails to track communications." />
        </div>
      </div>
    </div>
  );
