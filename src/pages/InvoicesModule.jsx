...
export default function InvoicesModule() {
  ...
  return (
    <div className="flex h-screen bg-white dark:bg-slate-900">
            ...
            <div className="flex gap-2">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem onClick={() => { setSelectedDeal(null); setEditingInvoice(null); setShowModal(true); }}>
                    Create Blank Invoice
                  </DropdownMenuItem>
                  {deals.length > 0 && (
                    <>
                      <div className="px-2 py-1.5 text-xs font-semibold text-gray-500">From Won Deals</div>
        ...
        <div className="flex-1 overflow-auto p-6 sm:p-8">
          {isLoading ? (
            ...
            <EmptyState 
              ...
              onAction={() => { setSelectedDeal(null); setEditingInvoice(null); setShowModal(true); }}
            />
          ) : (
            <div className="space-y-4">
              {filteredInvoices.map((invoice) => (
                <div key={invoice.id} className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-shadow">
                    ...
                    <div className="text-right">
                      ...
                      <div className="flex gap-2 mt-2">
                        <Button 
                          size="sm" 
                          variant="outline" 
                          onClick={() => { setEditingInvoice(invoice); setShowModal(true); }}
                        >
                          Edit
                        </Button>
      ...
      <InvoiceModal
        open={showModal}
        onClose={() => { setShowModal(false); setSelectedDeal(null); setEditingInvoice(null); }}
        onSave={handleSave}
