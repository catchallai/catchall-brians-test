    ...
    <div className="flex h-screen bg-white dark:bg-slate-900">
      ...
      <div className="flex-1 flex flex-col">
        <div className="border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-slate-900 p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Manage your companies</p>
            </div>
        ...
        <div className="flex-1 overflow-auto p-6 sm:p-8">
          <EmptyState icon={Building2} title="No companies yet" description="Start by adding your first company." />
        </div>
      </div>
    </div>
  );
