        ...
        <div className="border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-slate-900 p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <Button 
              ...
              size="sm"
              onClick={() => { setEditingSubscription(null); setShowModal(true); }}
            >
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center max-w-2xl mx-auto">
              <div className="mb-8">
                <svg width="220" height="180" viewBox="0 0 220 180" fill="none" className="mx-auto">
                  <rect x="140" y="30" width="150" height="120" rx="8" fill="#10B981" transform="translate(-50, 0)"/>
                  <rect x="145" y="35" width="140" height="110" rx="6" fill="white" transform="translate(-50, 0)"/>
                  
                  <circle cx="95" cy="90" r="35" fill="white" stroke="#10B981" strokeWidth="3"/>
                  <path d="M85 90 L92 97 L105 84" stroke="#10B981" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
                  
                  <text x="105" y="62" fontSize="12" fill="#6B7280" fontWeight="500">Your payment link</text>
                  <text x="105" y="77" fontSize="11" fill="#6B7280">is ready to be sent</text>
              ...
              <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400 text-left max-w-lg mb-6">
                <p className="flex gap-2"><span className="text-teal-600">→</span> Easily manage subscriptions from your CRM and generate reports to understand your recurring revenue</p>
                <p className="flex gap-2"><span className="text-teal-600">→</span> Simplify payment collection with automatic reminders and saved payment methods</p>
                <p className="flex gap-2"><span className="text-teal-600">→</span> No hidden charges and only pay transaction fees to collect online payment</p>
              </div>
              <Button 
                onClick={() => { setEditingSubscription(null); setShowModal(true); }}
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex gap-4 text-sm text-gray-500">
                          ...
                          {subscription.mrr > 0 && (
                            <span>MRR: ${subscription.mrr.toFixed(2)}</span>
                          )}
                      ...
                      <div className="text-right ml-4">
                        ...
                        <Button 
                          size="sm" 
                          variant="outline"
                          onClick={() => { setEditingSubscription(subscription); setShowModal(true); }}
                        >
